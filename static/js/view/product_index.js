define('main/product_index', ['jquery', 'main/utils', 'main/server', 'main/common', 'main/temple', 'main/ga', 'main/im'], function($, utils, server, common, temple, ga, im) {
  var exports = {},
    $body = $('body');
  ...
  exports.fetchProductData = function() {
    ...
    server.productIndex({
      ...
      utils.loading();
      data = data.data;
      $body.find('.main_content_box').html(temple.categoryTreeProduct(data.categories));
