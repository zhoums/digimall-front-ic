define('main/product_detail', ['jquery','main/utils','main/server','main/common','main/temple','main/post_inquiry','main/ga','main/im', 'jqsuperslide'], function($, utils, server, common, temple, post_inquiry,ga,im){
    var exports  = {},
    profile,
    $body = $('body'),
