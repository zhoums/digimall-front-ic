define('main/quote_index', ['jquery','main/utils','main/server','main/common','main/temple','jqui','main/ga','main/im','page_turning_plugin'], function($, utils, server, common, temple,jqui,ga,im){
    var exports  = {},
    $body = $('body'),
