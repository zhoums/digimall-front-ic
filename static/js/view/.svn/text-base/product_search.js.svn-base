define('main/product_search', ['jquery','jqform','main/utils','main/server','main/common','main/temple','jqui','main/post_inquiry','main/ga','main/im'], function($, jqform, utils, server, common, temple, jqui, post_inquiry,ga,im){
    var exports  = {},
    profile,
    $body = $('body'),
