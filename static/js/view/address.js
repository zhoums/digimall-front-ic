define('main/address', ['jquery','main/server','main/common','main/temple','main/utils','jqui','main/ga','main/im','page_turning_plugin'], function($, server, common, temple, utils, jqui,ga,im){
    var exports  = {},
    id,
    $body = $('body'),
