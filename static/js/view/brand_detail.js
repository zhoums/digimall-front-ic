define('main/brand_detail', ['jquery','main/utils','main/server','main/common','main/temple','main/ga','main/im','page_turning_plugin'], function($, utils, server, common, temple,ga,im){
    var exports  = {},
    $body = $('body'),
    pageSize = 6;
