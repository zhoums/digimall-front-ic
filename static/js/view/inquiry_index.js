define('main/inquiry_index', ['jquery','jqform','main/utils','main/server','main/common','main/temple','main/ga','main/im'], function($, jqform, utils, server, common, temple,ga,im){
    var exports  = {},
    $body = $('body'),
